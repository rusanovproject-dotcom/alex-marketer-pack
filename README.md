...
**Версия:** v2.0 (JTBD)
**Что нового vs v1.x:** переход с audience-pipeline (Internet-First) на JTBD (13 шагов на сегмент × 3-5 сегментов), новый скилл-критик `/jtbd-critic` (свежий взгляд в новом чате), Шаг 5.5 в онбординге — Алекс сам создаёт папку проекта.
